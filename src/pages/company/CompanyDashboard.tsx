...
const CompanyDashboard: React.FC = () => {
  ...
  try {
    ...
    // Fetch phone numbers for each application
    const applicationsWithPhone = await Promise.all(
      applicationData.map(async (app: Application) => {
        try {
          ...
          return { ...app, phone: "" }; // Fallback to empty string if fetch fails
        }
      })
    );
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  {forms.phone && ( // Display phone number if available
            ...
            {isLoadingProfile ? (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Subfield</label>
                    <input
                      type="text"
                      name="subfield"
