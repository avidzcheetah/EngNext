...
const RegisterCompanyPage: React.FC = () => {
  ...
  const isAdminMode =
    location.pathname === "/register/company" && user?.role === "admin";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/companyRoutes/createCompany`,
        {
          method: "POST",
          body: fd,
        }
          ...
          <div className="max-w-md w-full text-center">
            <Card className="p-8">
              ...
              <p className="text-gray-600 mb-6">
                The company "{formData.companyName}" has been successfully added
                to the system.
              </p>
            ...
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600">
                {isAdminMode
                  ...
                  : "Partner with Engineering students"}
              </p>
            </div>
        ...
        {!isAdminMode && (
          <div className="mt-4 text-center">
            <p className="text-xs text-gray-500">
              Company registrations require administrator approval before access
              is granted
            </p>
          </div>
        )}
